...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("https://ecommerce-bug-busters.vercel.app", "https://ecommerce-bugbusters-production.up.railway.app")); // Permitir orígenes
